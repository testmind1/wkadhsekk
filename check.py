...
# 필요 API KEY load
load_dotenv()
access = os.getenv('EoOkmp0dqBtuLIC5czL9exxyugPJuDTrCzdxyq8f')
secret = os.getenv('SbzUAjAmChh02BqeUBWtYRcjxxXZZ4UHJR8dAF4x')
upbit = pyupbit.Upbit(access, secret)
token = os.getenv('5039492879:AAE0s-2xe4iKmKI0KQNcUfuKHpVM8wfPbcs')
mc = os.getenv('1141142506')
